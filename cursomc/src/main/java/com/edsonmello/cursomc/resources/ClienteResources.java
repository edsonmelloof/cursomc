...
public class ClienteResources {
	...
	public ResponseEntity<Cliente> find(@PathVariable Integer id) {
		...
		Cliente obj = clienteSer.find(id);
	...
	public ResponseEntity<Void> update(@Valid @RequestBody ClienteDTO objDto, @PathVariable Integer id){
		Cliente obj = clienteSer.fromDTO(objDto);
		obj.setId(id);
		obj = clienteSer.update(obj);
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		List<Cliente> list = clienteSer.findAll();
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<Cliente> list = clienteSer.findPage(page, linesPerPage, orderBy, direction);
